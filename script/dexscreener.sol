...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function getReserves() internal view returns (uint112 _reserve0, uint112 _reserve1, uint32 _blockTimestampLast) {
        _reserve0 = reserve0;
        _reserve1 = reserve1;
...
contract UpgradeScript is Script {
    ...
    function run() public returns (IVault, VC, VeVC) {
        ...
        UniswapV2Factory factory = new UniswapV2Factory(tx.origin);

        MockERC20 t1 = new MockERC20("a", "a");
        t1.mint(100e18);
        UniswapV2Pair p =
            UniswapV2Pair(factory.createPair(address(t1), address(0x176211869cA2b568f2A7D4EE941E073a821EE1ff)));

        t1.transfer(address(p), 10e18);
        IERC20(0x176211869cA2b568f2A7D4EE941E073a821EE1ff).transfer(address(p), 10000);
